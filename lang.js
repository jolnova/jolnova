...
const TR = {
  ...
  "It rewrites the burned-in subtitles of an approved clip in another language — English, Turkish, German, French or Spanish — and re-renders the clip once from the clean master. Useful when the audience you want does not speak the language of the stream. Studio and Agency.": "Onayladığın bir klibin gömülü altyazısını başka bir dilde yeniden yazar — İngilizce, Türkçe, Almanca, Fransızca ya da İspanyolca — ve klibi temiz ustadan bir kez yeniden işler. Ulaşmak istediğin kitle yayının dilini konuşmuyorsa işe yarar. Studio ve Agency.",
