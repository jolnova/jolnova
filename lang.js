...
const TR = {
  ...
  "This member pays through Stripe.": "Bu üye Stripe üzerinden ödüyor.",
  "Changing the plan here would not last: Stripe writes the plan back at the next renewal, the card is still charged the old price, and the revenue figure breaks.": "Paketi buradan değiştirmek kalıcı olmaz: Stripe bir sonraki yenilemede planı geri yazar, karttan yine eski planın parası çekilir ve gelir rakamı bozulur.",
  "Change it in Stripe instead: Customers → the subscription → Update subscription. Stripe charges the difference and the new plan arrives here by itself.": "Bunun yerine Stripe'tan değiştir: Customers → abonelik → Update subscription. Stripe farkı tahsil eder ve yeni paket buraya kendiliğinden gelir.",
  "Plan not changed — managed by Stripe.": "Paket değişmedi — Stripe yönetiyor.",
  "paid":"ödendi",
  ...
  "Each plan — Solo, Studio and Agency — covers Kick, Twitch, YouTube and TikTok together; there is no per-platform version and no platform to choose. The creator limit is one total across the four. Video files processed from your own computer are included with every plan and are never counted against that limit.": "Her paket — Solo, Studio ve Agency — Kick, Twitch, YouTube ve TikTok'u birlikte kapsar; platforma göre ayrı bir sürüm ve seçilecek bir platform yoktur. Yayıncı limiti dördü için tek bir toplamdır. Kendi bilgisayarından işlenen video dosyaları her pakete dahildir ve bu limite asla sayılmaz.",
  "Availability also depends on your plan — subtitle styling comes with every paid plan, and hiding the platform badge with Studio and Agency. Subtitles themselves are burned in on every plan, and fixing a misheard word is free everywhere.": "Kullanılabilirlik paketine de bağlıdır — altyazı görünümü her ücretli pakette, platform rozetini gizleme Studio ve Agency'de gelir. Altyazının kendisi her pakette gömülür ve yanlış duyulan bir kelimeyi düzeltmek her yerde ücretsizdir.",
  "The platform badge and channel line — hide it on Studio and Agency": "Platform rozeti ve kanal satırı — Studio ve Agency'de gizlenebilir",
  "Font, size, colour, outline, placement and a background box on every paid plan": "Her ücretli pakette yazı tipi, boyut, renk, kontur, yerleşim ve arka plan kutusu",
  "Jolnova checks your Kick, Twitch, YouTube and TikTok sources continuously. The moment a channel goes live, recording begins by itself — you do not have to be at the computer when it starts. Solo records four streams at once; Studio and Agency set no limit in the software.": "Jolnova; Kick, Twitch, YouTube ve TikTok kaynaklarını sürekli kontrol eder. Kanal canlıya geçtiği an kayıt kendi başlar — o sırada bilgisayar başında olman gerekmez. Solo aynı anda dört yayın kaydeder; Studio ve Agency'de yazılım bir sınır koymaz.",
  "Pull up to ten extra seconds back from the recording on Studio and Agency": "Studio ve Agency'de kayıttan on saniyeye kadar fazladan süre geri çek",
  "Font, size, colour, outline, placement and background box on every paid plan": "Her ücretli pakette yazı tipi, boyut, renk, kontur, yerleşim ve arka plan kutusu",
  "Several streams at once — 4 on Solo, no software limit on Studio and Agency": "Aynı anda birden fazla yayın — Solo'da 4, Studio ve Agency'de yazılım sınırı yok",
  "Export resolution follows your plan and your source: 1080p on Solo and Studio, and 4K on Agency when the source is 4K. Twitch and Kick broadcast at 1080p at most.": "Dışa aktarma çözünürlüğü paketini ve kaynağını izler: Solo ve Studio'da 1080p, kaynak 4K ise Agency'de 4K. Twitch ve Kick en fazla 1080p yayınlar.",
  "Clip Context pulls extra seconds back from the original recording — ±5 sec on Solo, ±10 on Studio and Agency": "Klip Bağlamı orijinal kayıttan fazladan saniye geri çeker — Solo'da ±5 sn, Studio ve Agency'de ±10",
  "Hide the platform name and channel line — Studio and Agency": "Platform adını ve kanal satırını gizle — Studio ve Agency",
  "Every plan burns subtitles into the clip and lets you fix a misheard word. Every paid plan adds styling — the font, colour and placement.": "Her paket altyazıyı klibin içine gömer ve yanlış duyulan bir kelimeyi düzeltmene izin verir. Her ücretli paket görünümü ekler — yazı tipi, renk ve yerleşim.",
  "Record several streams at once — 4 on Solo, no software limit on Studio and Agency": "Aynı anda birden fazla yayın kaydet — Solo'da 4, Studio ve Agency'de yazılım sınırı yok",
  "Not on a paid plan — Solo, Studio and Agency all process as many YouTube links as you paste in. The free trial is the exception: 2 links in total, not per month, because the trial only lasts three days and a monthly renewal would never arrive. Local files and tracked live sources are never counted either way.": "Ücretli pakette yok — Solo, Studio ve Agency yapıştırdığın kadar YouTube linkini işler. İstisna ücretsiz denemedir: ayda değil, toplamda 2 link; çünkü deneme yalnızca üç gün sürer ve aylık bir yenileme hiç gelmez. Yerel dosyalar ve takip edilen canlı kaynaklar hiçbir durumda sayılmaz.",
  "All three burn subtitles into the clip, let you fix a misheard word, turn the watermark off and take unlimited YouTube links. Solo tracks 3 creators, records four streams at once, exports up to 1080p and gives ±5 sec Clip Context. Studio raises the creator limit to 15, widens Clip Context to ±10 sec, sets no limit on simultaneous recordings, and adds sports mode, subtitle translation, scheduled uploads and hiding the platform badge. Agency raises the creator limit to 50, lifts the export ceiling to 4K where the source allows it, and adds priority processing and support.": "Üçü de altyazıyı klibin içine gömer, yanlış duyulan bir kelimeyi düzeltmene izin verir, filigranı kapatabilir ve sınırsız YouTube linki alır. Solo 3 yayıncı takip eder, aynı anda dört yayın kaydeder, en fazla 1080p dışa aktarır ve ±5 sn Klip Bağlamı verir. Studio yayıncı limitini 15'e çıkarır, Klip Bağlamı'nı ±10 sn'ye genişletir, aynı anda kayıtta sınır koymaz; spor modunu, altyazı çevirisini, zamanlanmış yüklemeyi ve platform rozetini gizlemeyi ekler. Agency yayıncı limitini 50'ye çıkarır, kaynağın izin verdiği yerde dışa aktarma tavanını 4K'ya taşır ve öncelikli işleme ile öncelikli desteği ekler.",
  "Yes, on Studio and Agency. The platform name and channel line are drawn by Jolnova rather than by the source, so hiding them leaves the picture untouched.": "Evet, Studio ve Agency'de. Platform adını ve kanal satırını kaynak değil Jolnova çizer; bu yüzden gizlemek görüntüye dokunmaz.",
  "Yes, on every paid plan. You can set the font, size and text colour, the outline weight and its colour, one of nine placements in the frame, the distance from the edge, and an optional solid background box with its own colour and opacity.": "Evet, her ücretli pakette. Yazı tipini, boyutu ve yazı rengini, kontur kalınlığını ve rengini, karedeki dokuz yerleşimden birini, kenardan uzaklığı ve isteğe bağlı olarak kendi rengi ve saydamlığı olan dolu bir arka plan kutusunu ayarlayabilirsin.",
  "Saving re-renders the clip once from a clean master, so correcting the text twice does not stack quality loss. Fixing a misheard word is free on every plan, because that is our mistake to repair; changing how the subtitles look comes with every paid plan.": "Kaydetmek klibi temiz bir kaynaktan bir kez yeniden işler; metni iki kez düzeltmek kalite kaybını üst üste bindirmez. Yanlış duyulan bir kelimeyi düzeltmek her pakette ücretsizdir, çünkü o bizim tamir etmemiz gereken bir hatadır; altyazının görünümünü değiştirmek ise her ücretli pakette gelir.",
  "Yes, on every plan, the free trial included. Every subtitle line is listed with its timecode and stays editable: correct a misheard word, rewrite the whole sentence, or delete a line you do not want on screen. Timings stay exactly as transcribed — only the words change.": "Evet, ücretsiz deneme dahil her pakette. Her altyazı satırı zaman koduyla listelenir ve düzenlenebilir kalır: yanlış duyulan bir kelimeyi düzelt, cümlenin tamamını yeniden yaz ya da ekranda istemediğin bir satırı sil. Zamanlamalar yazıya döküldüğü gibi kalır — yalnızca kelimeler değişir.",
  "One during the free trial and four on Solo. Studio and Agency set no limit in the software, so your disk decides: a live recording uses about 5.6 GB per stream per hour. This is not the same as the creator limit — you can track fifty channels and have four of them recording at once.": "Ücretsiz denemede bir, Solo'da dört. Studio ve Agency'de yazılım bir sınır koymaz; sınırı diskin belirler: canlı kayıt yayın başına saatte yaklaşık 5,6 GB yer kaplar. Bu, yayıncı limitiyle aynı şey değildir — elli kanal takip edip bunlardan dördünü aynı anda kaydedebilirsin.",
  "It depends on your plan: 3 creators on Solo, 15 on Studio and 50 on Agency. There is no platform split — the number is one total across Kick, Twitch, YouTube and TikTok. The free trial tracks 2.": "Paketine bağlı: Solo'da 3 yayıncı, Studio'da 15, Agency'de 50. Platform ayrımı yok — sayı Kick, Twitch, YouTube ve TikTok için tek bir toplamdır. Ücretsiz deneme 2 yayıncı takip eder.",
  "It counts the clips you approve, not the ones Jolnova produces. Everything lands in the review queue first and a clip you reject costs you nothing. There is no daily ceiling: if you want to spend the whole month in one day, you can.": "Jolnova'nın ürettiği klipleri değil, senin onayladıklarını sayar. Her şey önce inceleme kuyruğuna düşer ve reddettiğin klip sana hiçbir şeye mal olmaz. Günlük tavan yoktur: ayın hakkını tek günde harcamak istiyorsan harcayabilirsin.",
  "Vertical 9:16, with the watermark on or off as you prefer on any paid plan. The resolution ceiling follows your plan: 720p during the free trial, 1080p on Solo and Studio, 4K on Agency. A ceiling is not a promise. Twitch and Kick broadcast at 1080p at most, so a clip cut from a live stream comes out at 1080p whatever your plan says. You reach 4K only when the source is already 4K: a YouTube video, or a recording of your own.": "Dikey 9:16; filigran ücretli paketlerin hepsinde açık ya da kapalı, nasıl istersen. Çözünürlük tavanı paketine göre değişir: ücretsiz denemede 720p, Solo ve Studio'da 1080p, Agency'de 4K. Tavan bir söz değildir. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından kesilen bir klip, paketin ne derse desin 1080p çıkar. 4K'ya ancak kaynak zaten 4K ise ulaşırsın: bir YouTube videosu ya da kendi kaydettiğin bir video.",
  "Whichever runs out first — the three days or the fifty clips — stops new clip production. Your review queue and clip library are files on your own computer, so they stay where they are and can still be approved, edited and exported.": "Hangisi önce biterse — üç gün ya da elli klip — yeni klip üretimi durur. İnceleme kuyruğun ve klip kütüphanen kendi bilgisayarındaki dosyalardır; oldukları yerde kalır ve onaylanabilir, düzenlenebilir, dışa aktarılabilir.",
  "Export resolution is a ceiling, not a promise. Twitch and Kick broadcast at 1080p at most, so a clip taken from a live stream comes out at 1080p even on Agency. You reach 4K only when the source is already 4K: a YouTube video, or a recording of your own.": "Dışa aktarma çözünürlüğü bir tavandır, söz değil. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından alınan bir klip Agency'de bile 1080p çıkar. 4K'ya ancak kaynak zaten 4K ise ulaşırsın: bir YouTube videosu ya da kendi kaydettiğin bir video.",
  "Whichever runs out first — the three days or the fifty clips — stops new clip production. Your review queue and clip library are files on your own computer, so they stay where they are and can still be approved, edited and exported. Running out of YouTube links only closes that one route; clips from live sources and from your own files keep coming until the days or the clip cap end the trial.": "Hangisi önce biterse — üç gün ya da elli klip — yeni klip üretimi durur. İnceleme kuyruğun ve klip kütüphanen kendi bilgisayarındaki dosyalardır; oldukları yerde kalır ve onaylanabilir, düzenlenebilir, dışa aktarılabilir. YouTube linki hakkının bitmesi yalnızca o yolu kapatır; canlı kaynaklardan ve kendi dosyalarından klip üretimi, gün ya da klip sınırı denemeyi bitirene kadar sürer.",
  "When the trial ends, new clip production stops. The clips you already made are files on your own computer, in the Jolnova data folder — we do not store them, so they are yours to export or delete whenever you like.": "Deneme bitince yeni klip üretimi durur. Ürettiğin klipler kendi bilgisayarındaki dosyalardır, Jolnova veri klasöründe durur — onları biz saklamıyoruz, istediğin zaman dışa aktarabilir ya da silebilirsin.",
  "When the trial ends, new clip production stops. The clips you already made are files on your own computer and stay where they are.": "Deneme bitince yeni klip üretimi durur. Ürettiğin klipler kendi bilgisayarındaki dosyalardır ve oldukları yerde kalır.",
  "Your review queue and clip library are files on your own computer, so they stay where they are and can still be approved, edited and exported.": "İnceleme kuyruğun ve klip kütüphanen kendi bilgisayarındaki dosyalardır; oldukları yerde kalır ve onaylanabilir, düzenlenebilir, dışa aktarılabilir.",
  "A ceiling is not a promise. Twitch and Kick broadcast at 1080p at most, so a clip cut from a live stream comes out at 1080p whatever your plan says. You reach 4K only when the source is already 4K: a YouTube video, or a recording of your own.": "Tavan bir söz değildir. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından kesilen bir klip, paketin ne derse desin 1080p çıkar. 4K'ya ancak kaynak zaten 4K ise ulaşırsın: bir YouTube videosu ya da kendi kaydettiğin bir video.",
  "ceiling, not a promise. Twitch and Kick broadcast at 1080p at most, so a clip taken from a live stream comes out at 1080p even on Agency. You reach 4K only when the source is already 4K: a YouTube video, or a recording of your own.": "tavandır, söz değil. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından alınan bir klip Agency'de bile 1080p çıkar. 4K'ya ancak kaynak zaten 4K ise ulaşırsın: bir YouTube videosu ya da kendi kaydettiğin bir video.",
  ...
  "Everything it made lands in one queue.": "Ürettiği her şey tek bir kuyruğa düşer.",
  "Fix what it mishears.": "Yanlış duyduğunu düzelt.",
  "What can you change after the cut?": "Kesildikten sonra neyi değiştirebilirsin?",
  "Who uses it": "Kimler kullanıyor",
  "The tracking view: which sources are being watched, and which one is recording right now.": "Takip ekranı: hangi kaynaklar izleniyor ve şu anda hangisi kaydediliyor.",
  "Windows 10 / 11 · runs locally": "Windows 10 / 11 · yerelde çalışır",
  "How it is picked up": "Nasıl alınıyor",
  "What to know": "Bilinmesi gereken",
  "Not in Jolnova": "Jolnova'da olmayan",
  "What that means for you": "Bunun senin için anlamı",
...
"Cancel anytime.": "İstediğin zaman iptal et.",
  ...
  "Review queue — you approve every clip": "İnceleme kuyruğu — her klibi kendiniz onaylarsınız",
  ...
  "Approved clips a month": "Onaylanan klip / ay",
  "My Files and link imports — unlimited": "Kendi dosyaların ve link ile içe aktarma — sınırsız",
  "My Files and link imports": "Kendi dosyaların ve link ile içe aktarma",
  "Subtitle text editing and styling": "Altyazı metni düzenleme ve görünüm ayarı",
  "±5 sec Clip Context": "±5 sn Klip Bağlamı",
  "Subtitle translation": "Altyazı çevirisi",
  "Upload to YouTube — now or scheduled": "YouTube'a yükleme — hemen ya da zamanlanmış",
  "Sports mode — goals and key moments": "Spor modu — goller ve önemli anlar",
  "Subtitle translation — 5 languages": "Altyazı çevirisi — 5 dil",
  "For teams running several channels at once": "Aynı anda birden fazla kanal işleten ekipler için",
  "Everything in Studio": "Studio'daki her şey",
  "Priority processing": "Öncelikli işleme",
  "Priority processing and support": "Öncelikli işleme ve destek",
  "Export resolution is a ceiling, not a promise. Twitch and Kick broadcast at 1080p at most, so a clip taken from a live stream comes out at 1080p even on Agency. 4K is reachable when the source itself is 4K — a YouTube video or one of your own recordings.": "Dışa aktarma çözünürlüğü bir tavandır, bir söz değil. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından alınan bir klip Agency'de bile 1080p çıkar. 4K ancak kaynağın kendisi 4K ise mümkündür — bir YouTube videosu ya da kendi kaydın.",
  "* Every plan burns subtitles into the clip, and every paid plan can edit them: correct a misheard word, rewrite a line, delete one you do not want, and change how the subtitles look.": "* Her paket altyazıyı klibe gömer ve her ücretli paket onu düzenleyebilir: yanlış duyulan bir kelimeyi düzelt, bir satırı yeniden yaz, istemediğini sil, görünümünü değiştir.",
  "Solo covers one of Twitch, Kick, YouTube and TikTok — chosen by you inside the application. Studio and Agency cover all four at once.": "Solo; Twitch, Kick, YouTube ve TikTok'tan birini kapsar — hangisi olduğunu uygulamanın içinde sen seçersin. Studio ve Agency dördünü birden kapsar.",
  "On Solo you open Settings and choose Twitch, Kick, YouTube or TikTok. A source from a platform you did not select cannot be added.": "Solo'da Ayarlar'ı açıp Twitch, Kick, YouTube ya da TikTok'u seçersin. Seçmediğin bir platformdan kaynak eklenemez.",
  "Change it when you need to": "İhtiyaç oldukça değiştir",
  "Studio and Agency pool the limit": "Studio ve Agency limiti ortak havuzda tutar",
  "The creator limit is a single total across all four platforms, so you can spend it however you like — fifteen on one platform or a handful on each.": "Yayıncı limiti dört platformun tamamı için tek bir toplamdır; nasıl istersen öyle harcarsın — hepsi tek platformda ya da her birine birkaç tane.",
  "Processing a video already on your computer is not a platform and never counts against your platform choice — on Solo, Studio, Agency and during the free trial alike.": "Bilgisayarındaki bir videoyu işlemek platform sayılmaz ve platform seçimini hiçbir zaman etkilemez — Solo, Studio, Agency ve ücretsiz deneme dahil.",
  "Solo — 3 creators on the one platform you picked": "Solo — seçtiğin tek platformda 3 yayıncı",
  "Studio — 15 creators, counted as one total across all four platforms": "Studio — dört platform için tek toplam olarak 15 yayıncı",
  "Agency — 50 creators, counted the same way": "Agency — aynı şekilde sayılan 50 yayıncı",
  "Solo records up to 4 streams at once; Studio and Agency are limited by disk, not by plan": "Solo aynı anda en fazla 4 yayın kaydeder; Studio ve Agency'de sınır paket değil disktir",
  "What is the difference between Solo, Studio and Agency?": "Solo, Studio ve Agency arasındaki fark nedir?",
  "Solo follows 3 creators on one platform you choose, and gives you 100 approved clips a month. Studio opens all four platforms, raises the limit to 15 creators and 500 clips, and adds the three things a clip page actually needs: uploading to YouTube, sports mode and subtitle translation. Agency is the same product at volume — 50 creators, 2000 clips, 4K export where the source allows it, and priority processing and support.": "Solo, seçtiğin tek platformda 3 yayıncı takip eder ve ayda 100 onaylanan klip verir. Studio dört platformu birden açar, limiti 15 yayıncı ve 500 klibe çıkarır ve bir klip sayfasının gerçekten ihtiyaç duyduğu üç şeyi ekler: YouTube'a yükleme, spor modu ve altyazı çevirisi. Agency aynı ürünün hacimlisidir — 50 yayıncı, 2000 klip, kaynak elverdiğinde 4K dışa aktarma, öncelikli işleme ve destek.",
  "Subtitles, the subtitle editor, automatic clip detection, the review queue and My Files are on every paid plan.": "Altyazı, altyazı düzenleyici, otomatik klip tespiti, inceleme kuyruğu ve kendi dosyaların her ücretli pakette var.",
  "3 on Solo, 15 on Studio, 50 on Agency. On Studio and Agency that number is a single pooled total across Twitch, Kick, YouTube and TikTok — spend it however you like. Tracking a creator and recording one are different limits: you can follow fifteen channels and have several of them recording at once.": "Solo'da 3, Studio'da 15, Agency'de 50. Studio ve Agency'de bu sayı Twitch, Kick, YouTube ve TikTok için tek bir ortak toplamdır — nasıl istersen öyle harcarsın. Takip etmek ile kaydetmek ayrı limitlerdir: on beş kanal takip edip birkaçını aynı anda kaydedebilirsin.",
  "What does \"approved clips a month\" mean?": "\"Ayda onaylanan klip\" ne demek?",
  ...
  "It lets you pull the start and end of a clip outwards, taken from the original recording rather than from the cut file. Useful when the setup to a joke sits just outside the detected moment. ±5 sec on Solo, ±10 sec on Studio and Agency.": "Klibin başını ve sonunu dışarı doğru genişletmeni sağlar; bu ek saniyeler kesilmiş dosyadan değil orijinal kayıttan alınır. Şakanın kurulumu tespit edilen anın hemen dışında kaldığında işe yarar. Solo'da ±5 sn, Studio ve Agency'de ±10 sn.",
  "Is there a limit on links and my own files?": "Linklerde ve kendi dosyalarımda sınır var mı?",
  "Not on a paid plan — Solo, Studio and Agency all process as many links and local videos as you give them. The free trial is the exception: 2 links in total, not per month, because the trial only lasts three days and a monthly renewal would never arrive.": "Ücretli pakette yok — Solo, Studio ve Agency verdiğin kadar linki ve yerel videoyu işler. İstisna ücretsiz deneme: ayda değil, toplam 2 link. Çünkü deneme yalnızca üç gün sürüyor ve aylık bir yenilenme hiç gelmezdi.",
  "Only on Agency, and only when the source is already 4K — a YouTube video or a recording of your own. Twitch and Kick broadcast at 1080p at most, so a clip cut from a live stream comes out at 1080p whatever your plan says. The plan sets a ceiling; it cannot add resolution that was never in the video.": "Yalnızca Agency'de ve yalnızca kaynak zaten 4K ise — bir YouTube videosu ya da kendi kaydın. Twitch ve Kick en fazla 1080p yayın yapar; canlı yayından kesilen bir klip paketin ne derse desin 1080p çıkar. Paket bir tavan belirler; videoda hiç olmayan çözünürlüğü ekleyemez.",
  "Only if you set it up. Connect a YouTube account on the Sharing page, approve a clip and pick a day and time — it goes out then. Nothing is uploaded that you did not approve and schedule, and the file sent is the clip as produced, with no re-encoding.": "Yalnızca sen kurarsan. Paylaşım sayfasından bir YouTube hesabı bağla, bir klibi onayla ve gün ile saati seç — o zaman gider. Onaylamadığın ve zamanlamadığın hiçbir şey yüklenmez; gönderilen dosya üretildiği hâliyle klibin kendisidir, yeniden kodlama yoktur.",
  // ---- gezinme ----
  ...
  "Camera + gameplay for gaming, full screen for IRL. Captions burned in automatically.":
    "Oyun için kamera+ekran, IRL için tam ekran. Otomatik video entegre altyazı.",
  ...
  "Captions burned in, platform badge matched to": "Video entegre altyazı, platform rozeti şuna göre:",
  ...
  "Add a source once. Jolnova watches it in the background, records the broadcast and prepares vertical clips with titles and burned-in subtitles. New clips land in a review queue, waiting for your approval.": "Bir kez kaynak ekle. Jolnova arka planda izler, yayını kaydeder ve başlıklı, video entegre altyazılı dikey klipler hazırlar. Yeni klipler onayını bekleyen bir inceleme kuyruğuna düşer.",
  ...
  "Burned-in subtitles": "Video entegre altyazı",
  ...
  "Point Jolnova at a local recording and get vertical segments with subtitles already burned in.": "Jolnova'yı yerel bir kayda yönlendir; video entegre altyazılı dikey bölümler al.",
  ...
  "Transcribed, burned-in subtitles": "Yazıya dökülmüş, video entegre altyazı",
  ...
  "It is a Windows application that watches the stream sources you add, records them when they go live, finds moments worth clipping, cuts them into vertical videos with burned-in subtitles, and puts them in a queue for you to approve. Titles are written when you approve a clip.": "Eklediğin yayın kaynaklarını izleyen, canlıya geçtiklerinde kaydeden, klip olmaya değer anları bulan, bunları video entegre altyazılı dikey videolara kesen ve onayın için bir kuyruğa koyan bir Windows uygulamasıdır. Başlıklar, sen klibi onayladığında yazılır.",
  "Add a source once. Jolnova watches it in the background, records the broadcast and prepares vertical clips with burned-in subtitles. New clips land in a review queue, and the AI writes the title when you approve one.": "Kaynağı bir kez ekle. Jolnova arka planda izler, yayını kaydeder ve video entegre altyazılı dikey klipler hazırlar. Yeni klipler inceleme kuyruğuna düşer; birini onayladığında başlığı AI yazar.",
  ...
  "Up to": "Toplam",
  "creators tracked": "yayıncıya kadar",
  ...
  "720p maximum export": "720p kalitede dışa aktarım",
  "4K maximum export": "4K kalitede dışa aktarım",
  "1080p maximum export": "1080p kalitede dışa aktarım",
  ...
  "4. Retention and deletion": "4. Saklama ve silme",
  "YouTube data.": "YouTube verileri.",
  "We store no YouTube statistics at all. Subscriber and video counts are requested live only while they are on screen, and are never written to disk. The connected channel's name and picture are cached on your own computer for at most 6 hours — far inside YouTube's 30-day limit — and are fetched again from the API after that. Your access token is deleted from your disk the moment you press “Disconnect”.": "Hiçbir YouTube istatistiğini saklamıyoruz. Abone ve video sayıları yalnızca ekranda göründükleri sırada canlı olarak isteniyor, diske hiç yazılmıyor. Bağlı kanalın adı ve görseli kendi bilgisayarında en fazla 6 saat önbellekte tutuluyor — YouTube'un 30 günlük sınırının çok altında — ve sonrasında API'den yeniden alınıyor. Erişim anahtarın ise “Bağlantıyı kes”e bastığın anda diskinden siliniyor.",
  "5. Cookies and browser storage": "5. Çerezler ve tarayıcı depolaması",
  "This website sets no advertising, analytics or tracking cookies, and we allow no third party to profile you here. What the site does keep is a small amount of data in your own browser's local storage, so that it works and remembers what you chose:": "Bu sitede reklam, analiz ya da takip çerezi yok; hiçbir üçüncü tarafın burada seni profillemesine izin vermiyoruz. Sitenin sakladığı tek şey, çalışabilmesi ve seçtiklerini hatırlayabilmesi için kendi tarayıcının yerel deposunda duran küçük bir veri:",
  "Theme (rj_tema)": "Tema (rj_tema)",
  "— whether you picked the light or the dark look.": "— açık mı koyu görünümü mü seçtiğin.",
  "Language (rj_lang)": "Dil (rj_lang)",
  "— the language you picked, so the site opens in it next time.": "— seçtiğin dil; site bir dahaki sefere onunla açılsın diye.",
  "Sign-in session": "Oturum",
  "— when you log in, the session token is kept in local storage so you stay signed in between visits. Signing out deletes it.": "— giriş yaptığında oturum anahtarın yerel depoda tutuluyor, böylece ziyaretler arasında açık kalıyorsun. Çıkış yapınca siliniyor.",
  "Account name and plan (jolnova_profil)": "Hesap adı ve plan (jolnova_profil)",
  "— a copy kept only so the header can show them without asking the server again. Signing out deletes it.": "— yalnızca üst çubuk bunları sunucuya tekrar sormadan gösterebilsin diye tutulan bir kopya. Çıkış yapınca siliniyor.",
  "All of this stays inside your browser on your own device. None of it is used for advertising, and clearing your browser data removes every item — you are simply signed out and the site returns to its defaults.": "Bunların hepsi kendi cihazında, tarayıcının içinde kalıyor. Hiçbiri reklam için kullanılmıyor ve tarayıcı verilerini temizlediğinde hepsi siliniyor — sadece oturumun kapanır ve site varsayılanlarına döner.",
  "Our hosting provider (Cloudflare) may set one strictly necessary cookie of its own to protect the site from automated abuse. It carries no advertising identifier and is not used to track you across other sites.": "Barındırma sağlayıcımız (Cloudflare) siteyi otomatik kötüye kullanıma karşı korumak için kendi zorunlu çerezinden bir tane koyabiliyor. İçinde reklam kimliği yok ve başka sitelerde seni izlemek için kullanılmıyor.",
  "The Jolnova application is not a browser and uses no cookies at all. Your settings and your YouTube token are ordinary files in your own Windows user folder — see sections 1 and 3.": "Jolnova uygulaması bir tarayıcı değil ve hiç çerez kullanmıyor. Ayarların ve YouTube anahtarın, kendi Windows kullanıcı klasöründe duran sıradan dosyalar — 1. ve 3. bölümlere bak.",
  "6. Third-party services": "6. Üçüncü taraf hizmetler",
  "7. Children's privacy": "7. Çocukların gizliliği",
  "8. Changes": "8. Değişiklikler",
  "9. Contact": "9. İletişim",
  ...
  /* ==== INDIRME SAYFASI — 2026-09 yeniden tasarim ====
     download.html yeni bolumleri: indirme kutusu, kurulum adimlari,
     SmartScreen aciklamasi, sistem gereksinimleri, indirme SSS'si.
     Windows diyalogundaki uc satir isletim sisteminin KENDI resmi
     cevirisidir; kullanici ekranda birebir onu gorecek. */
  "DOWNLOAD": "İNDİR",
  "LATEST BUILD": "SON SÜRÜM",
  "Run the setup file and follow the wizard. On first launch Jolnova fetches its video toolkit by itself — there is nothing else to install.": "Kurulum dosyasını çalıştır ve sihirbazı takip et. Jolnova ilk açılışta video araç takımını kendisi indirir — kurman gereken başka bir şey yok.",
  "Every release on GitHub": "GitHub'daki tüm sürümler",
  "What Windows will ask you": "Windows sana ne soracak",
  "Free for 3 days — no card": "3 gün ücretsiz — kart yok",
  "Recording and clipping run on your PC": "Kayıt ve klipleme bilgisayarında çalışır",
  "Uninstall like any Windows program": "Her Windows programı gibi kaldırılır",
  "From installer to first clip.": "Kurulumdan ilk klibe.",
  "Four steps, and only two of them need you. The rest is the app setting itself up.": "Dört adım var, ikisi seni bekliyor. Gerisini uygulama kendi kendine hallediyor.",
  "Run the installer": "Kurulumu çalıştır",
  "Windows 10 or 11, 64-bit": "Windows 10 ya da 11, 64 bit",
  "Installed for your own user account": "Kendi kullanıcı hesabına kurulur",
  "The video toolkit installs itself": "Video araç takımı kendini kurar",
  "On first launch Jolnova fetches FFmpeg, the tool it uses to cut and encode video. It happens once and takes about a minute on a normal connection.": "Jolnova ilk açılışta, video kesmek ve kodlamak için kullandığı FFmpeg'i indirir. Bu bir kez olur ve normal bir bağlantıda yaklaşık bir dakika sürer.",
  "Nothing to find or configure": "Bulman ya da ayarlaman gereken bir şey yok",
  "An account is required — it is free": "Hesap gerekli — ücretsiz",
  "Clips wait for your approval": "Klipler onayını bekler",
  "Windows will probably warn you. Here is why.": "Windows muhtemelen seni uyaracak. Nedeni şu.",
  "The installer is not code-signed yet, so Microsoft Defender SmartScreen steps in the first time you run it. The warning means Windows has not seen this file often enough to recognise it — not that it found something in it.": "Kurulum dosyası henüz kod imzalı değil; bu yüzden ilk çalıştırdığında Microsoft Defender SmartScreen araya giriyor. Uyarı, Windows'un bu dosyayı tanıyacak kadar sık görmediği anlamına gelir — içinde bir şey bulduğu anlamına değil.",
  "Windows protected your PC": "Windows bilgisayarınızı korudu",
  "Microsoft Defender SmartScreen prevented an unrecognised app from starting. Running this app might put your PC at risk.": "Microsoft Defender SmartScreen tanınmayan bir uygulamanın başlatılmasını engelledi. Bu uygulamayı çalıştırmak bilgisayarınızı riske atabilir.",
  "More info": "Daha fazla bilgi",
  "Run anyway": "Yine de çalıştır",
  "Don't run": "Çalıştırma",
  "This is the Windows dialog, not ours — the wording comes from the operating system.": "Bu pencere bizim değil Windows'un — metin işletim sisteminden geliyor.",
  "Getting past it": "Uyarıyı geçmek",
  "Choose More info in the dialog. The two buttons appear underneath.": "Pencerede “Daha fazla bilgi”ye tıkla. İki düğme onun altında beliriyor.",
  ...
  "We have applied for a code-signing certificate, so this warning will disappear soon. Until then every new release starts out unrecognised, whatever is inside it. If you would rather check the file first, download it straight from the GitHub Releases page and scan it before running.":"Kod imzalama sertifikası için başvurumuzu yaptık; bu uyarı yakında kalkacak. O zamana kadar her yeni sürüm, içinde ne olursa olsun, tanınmayan olarak başlıyor. Dosyayı önce kendin kontrol etmek istersen doğrudan GitHub Releases sayfasından indir ve çalıştırmadan önce taratabilirsin.",
  ...
  "Windows 10 or Windows 11, 64-bit.": "Windows 10 ya da Windows 11, 64 bit.",
  "Other platforms": "Diğer platformlar",
  "None. Jolnova is a Windows application — there is no macOS or Linux build.": "Yok. Jolnova bir Windows uygulaması — macOS ya da Linux sürümü bulunmuyor.",
  "Disk space": "Disk alanı",
  "Room for recordings. A live stream takes roughly 5.6 GB an hour, and the cleanup budget that caps it is a setting you control.": "Kayıtlar için yer. Canlı bir yayın saatte yaklaşık 5,6 GB tutar; bunu sınırlayan temizlik bütçesi senin belirlediğin bir ayardır.",
  "Internet connection": "İnternet bağlantısı",
  "Needed for live tracking, signing in and writing clip titles.": "Canlı takip, giriş ve klip başlıklarının yazılması için gerekli.",
  "Jolnova account": "Jolnova hesabı",
  "Created free on this site. The app asks for it the first time it opens.": "Bu sitede ücretsiz açılır. Uygulama ilk açıldığında bu hesabı ister.",
  "What the installer does": "Kurulum ne yapıyor",
  "Puts the application on your machine and adds a Start menu entry.": "Uygulamayı makinene kurar ve Başlat menüsüne bir kayıt ekler.",
  "Fetches the video toolkit once, on first launch.": "Video araç takımını ilk açılışta bir kez indirir.",
  "Creates a folder for recordings and finished clips — you can move it in Settings.": "Kayıtlar ve biten klipler için bir klasör açar — Ayarlar'dan taşıyabilirsin.",
  "Leaves your own videos where they are. My Files reads them in place.": "Kendi videolarını yerinde bırakır. Kendi dosyaların bulundukları yerden okunur.",
  "Keeps recording, moment detection and subtitles on your machine. Only the title-writing step leaves it.": "Kaydı, an algılamayı ve altyazıyı makinende tutar. Yalnızca başlık yazma adımı dışarı çıkar.",
  "Removing it is the same as any Windows program: Settings, then Apps, then Installed apps.": "Kaldırmak her Windows programındaki gibi: Ayarlar, sonra Uygulamalar, sonra Yüklü uygulamalar.",
  "An account is required": "Hesap gerekli",
  "Free for 3 days or 50 clips, whichever comes first.": "3 gün ya da 50 klip ücretsiz — hangisi önce gelirse.",
  "See the plans →": "Paketlere bak →",
  "DOWNLOAD QUESTIONS": "İNDİRME SORULARI",
  "Yes. Jolnova signs in to see which plan you are on, so the first screen after installing asks for the account you created here. Creating one is free and takes a minute.": "Evet. Jolnova hangi pakette olduğunu görmek için giriş yapar; bu yüzden kurulumdan sonraki ilk ekran burada oluşturduğun hesabı ister. Hesap açmak ücretsiz ve bir dakika sürüyor.",
  "Is it really free to try?": "Denemesi gerçekten ücretsiz mi?",
  "Three days, or fifty approved clips — whichever comes first, and no card is asked for. When the trial ends new clip production stops, but everything already in your queue and library stays where it is.": "Üç gün ya da elli onaylanan klip — hangisi önce gelirse; kart istenmiyor. Deneme bitince yeni klip üretimi durur ama kuyruğunda ve kitaplığında olan her şey olduğu yerde kalır.",
  "Why does Windows say the app is unrecognised?": "Windows neden uygulamayı tanımıyor diyor?",
  "Because the installer is not code-signed. SmartScreen warns about files it has not seen many times before, whatever is inside them. Choose More info, then Run anyway.": "Çünkü kurulum dosyası kod imzalı değil. SmartScreen, içinde ne olursa olsun daha önce çok kez görmediği dosyalar için uyarı verir. “Daha fazla bilgi”, sonra “Yine de çalıştır”ı seç.",
  "Where does the file actually come from?": "Dosya tam olarak nereden geliyor?",
  "From our GitHub Releases page. The button above links straight to the newest release asset there, so you can also open the releases page yourself, read what changed and download the file from GitHub directly.": "GitHub Releases sayfamızdan. Yukarıdaki düğme doğrudan oradaki en yeni sürüm dosyasına bağlanır; istersen sürümler sayfasını kendin açıp neyin değiştiğini okuyabilir ve dosyayı doğrudan GitHub'dan indirebilirsin.",
  "How do I update it later?": "Sonradan nasıl güncellerim?",
  "Download the installer from this page again and run it. The link always points at the latest release, so there is no version number to look up.": "Kurulum dosyasını bu sayfadan yeniden indirip çalıştır. Bağlantı her zaman en son sürümü gösterdiği için aranacak bir sürüm numarası yok.",
  "Is there a macOS or Linux version?": "macOS ya da Linux sürümü var mı?",
  "No. Jolnova is a Windows desktop application and records on the machine it runs on.": "Hayır. Jolnova bir Windows masaüstü uygulaması ve kaydı çalıştığı makinede yapıyor."
};
