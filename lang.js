...
"Cancel anytime.": "İstediğin zaman iptal et.",
  ...
  "↓ Start free": "↓ Ücretsiz başla",  // karsilastirma tablosu
  "COMPARE": "Karşılaştır",
  ...
  "Creators tracked per plan": "Pakete göre takip edilen yayıncı",  "The practical ceiling is your own disk space and CPU": "Pratik tavan kendi disk alanın ve işlemcindir",
  ...
  "Subtitle styling": "Altyazı stili",  "FREE TRIAL": "ÜCRETSİZ DENEME",
  ...
  "Live preview on a real frame — nothing is re-encoded while you tune it": "Gerçek bir kare üzerinde canlı önizleme — ayarlarken hiçbir şey yeniden kodlanmaz",  "TITLES AND METADATA": "BAŞLIK VE BİLGİLER",
  ...
  "Clip presets and run schedule": "Klip ön ayarları ve çalışma programı",  "Tracking a creator and recording one are different limits": "Bir yayıncıyı takip etmekle kaydetmek farklı limitlerdir",
  ...
  "Whichever runs out first ends the trial — the three days or the fifty clips. Nothing is deleted when it does: the clips you already produced stay in your library, ready to export.": "Hangisi önce biterse denemeyi o bitirir — üç gün ya da elli klip. Bittiğinde hiçbir şey silinmez: ürettiğin klipler kütüphanende, dışa aktarılmaya hazır durur.",  "✦ 4K only when the source is 4K. Live Twitch and Kick broadcasts are 1080p at most.": "✦ 4K yalnızca kaynak 4K olduğunda. Canlı Twitch ve Kick yayınları en fazla 1080p'dir.",  "Clip presets, the run schedule, automatic clip detection and My Files are on every plan.": "Klip ön ayarları, çalışma programı, otomatik klip tespiti ve Dosyalarım her pakette vardır.",
  "Can I fix a mistake in the subtitles?": "Altyazıdaki bir hatayı düzeltebilir miyim?",
  "Yes. Every subtitle line is listed with its timecode and stays editable: correct a misheard word, rewrite the sentence, or delete a line you do not want on screen. Timings stay exactly as transcribed. Saving re-renders the clip once from a clean master, so correcting it twice does not stack quality loss.": "Evet. Her altyazı satırı zaman koduyla listelenir ve düzenlenebilir kalır: yanlış anlaşılmış bir kelimeyi düzelt, cümleyi yeniden yaz ya da ekranda istemediğin satırı sil. Zamanlamalar yazıya döküldüğü gibi kalır. Kaydetmek klibi temiz bir asıl kopyadan bir kez yeniden işler; iki kez düzeltmek kalite kaybını üst üste bindirmez.",  "What is the run schedule?": "Çalışma programı nedir?",
  ...
  "No. Jolnova produces the clip file and you post it yourself. It does not connect to a posting account and never uploads anything on your behalf.": "Hayır. Jolnova klip dosyasını üretir, paylaşımı sen yaparsın. Bir paylaşım hesabına bağlanmaz ve senin adına hiçbir şey yüklemez.",  "Automatic clip detection, clip presets, the run schedule and My Files are on every plan. On top of all that, each plan comes in a Single Platform and an All Platforms version.": "Otomatik klip tespiti, klip ön ayarları, çalışma programı ve Dosyalarım her pakette vardır. Bunun üstüne her paket Tek Platform ve Tüm Platformlar sürümüyle gelir.",  "Yes, on every paid plan. It is a switch in Settings rather than a paid upgrade. During the free trial the Jolnova badge stays on.": "Evet, her ücretli pakette. Ücretli bir yükseltme değil, Ayarlar'daki bir anahtardır. Ücretsiz deneme boyunca Jolnova rozeti açık kalır.",
  ...
  "n/a": "yok",
  "My Files is included with every plan.": "Dosyalarım her pakete dahildir.",  "No. My Files is included with every plan, including the free trial. Processing a video sitting on your computer never touches your platform selection or your creator limit.": "Hayır. Dosyalarım, ücretsiz deneme dahil her pakete dahildir. Bilgisayarında duran bir videoyu işlemek platform seçimine de yayıncı limitine de dokunmaz.",
  ...
  "My account": "Hesabım",
  "Profile": "Profil",
  "Account:": "Hesap:",  "Leave these empty unless you want a new password. At least 8 characters.": "Yeni şifre istemiyorsan bu alanları boş bırak. En az 8 karakter.",
